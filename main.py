        ...
        if input == 'wmix3':
            ...
            for n in range(0, 9):
                if wittwer3[n] == 8:
                    w3z = n
                    break
            if _af_parity(wittwer3):
                if wittwer4[0] != 0:
                    if wittwer3[1] != 0:
                        wittwer3[[0,1]] = wittwer3[[1,0]]
                    else:
                        wittwer3[[0,2]] = wittwer3[[2,0]]
                else:
                    wittwer4[[1,2]] = witter4[[2,1]]
            ...
            for n in range(0, 16):
                if wittwer4[n] == 15:
                    w4z = n
                    break
            if _af_parity(wittwer4):
                if wittwer4[0] != 0:
                    if wittwer4[1] != 0:
                        wittwer4[[0,1]] = wittwer4[[1,0]]
                    else:
                        wittwer4[[0,2]] = wittwer4[[2,0]]
                else:
                    wittwer4[[1,2]] = witter4[[2,1]]
